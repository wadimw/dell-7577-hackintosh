 ...
 *
 * Disassembly of SSDT-12-OptTabl.aml, Mon Oct  7 00:17:24 2019
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00001C79 (7289)
 *     Revision         0x01
 *     Checksum         0xE8
 *     OEM ID           "OptRef"
...
DefinitionBlock ("", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.P0VC, UnknownObj)    // (from opcode)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        {
            Store ("<<< GC6I >>>", Debug)
            Store (\_SB.PCI0.LREN, \_SB.PCI0.PEG0.PEGP.LTRE)
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            If (LEqual (\_SB.GGIV (0x01010010), One))
            {
            ...
            Store (\_SB.PCI0.PEG0.PEGP.LTRE, \_SB.PCI0.LREN)
